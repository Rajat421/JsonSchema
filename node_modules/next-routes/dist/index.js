...
var nextPaths = ['/_next', '/_webpack/', '/__webpack_hmr', '/static/'];
...
var Routes = function () {
  ...
  _createClass(Routes, [{
    ...
    key: 'isNextPath',
    value: function isNextPath(url) {
      return nextPaths.some(function (path) {
  ...
  _createClass(Route, [{
    ...
    value: function getAs() {
      ...
      var qsKeys = keys.filter(function (key) {
        return !_this5.keyNames.includes(key);
      });
