(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'react-addons-css-transition-group', 'classnames', 'react-prop-types/lib/deprecated', 'react-prop-types/lib/isRequiredForA11y', '../constants/keyCodes', '../constants/CSSTransitionGroupTick', '../utils/toggleScroll', '../utils/PropTypes/oneRequiredForA11y', './Dialog', '../Helpers/Portal'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('react-addons-css-transition-group'), require('classnames'), require('react-prop-types/lib/deprecated'), require('react-prop-types/lib/isRequiredForA11y'), require('../constants/keyCodes'), require('../constants/CSSTransitionGroupTick'), require('../utils/toggleScroll'), require('../utils/PropTypes/oneRequiredForA11y'), require('./Dialog'), require('../Helpers/Portal'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.reactAddonsCssTransitionGroup, global.classnames, global.deprecated, global.isRequiredForA11y, global.keyCodes, global.CSSTransitionGroupTick, global.toggleScroll, global.oneRequiredForA11y, global.Dialog, global.Portal);
    global.DialogContainer = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _reactAddonsCssTransitionGroup, _classnames, _deprecated, _isRequiredForA11y, _keyCodes, _CSSTransitionGroupTick, _toggleScroll, _oneRequiredForA11y, _Dialog, _Portal) {
  'use strict';
  ...
  var DialogContainer = function (_PureComponent) {
    ...
    _createClass(DialogContainer, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        var el = this.props.renderNode || window;
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['style', 'className', 'dialogStyle', 'dialogClassName', 'modal', 'fullPage', 'component', 'transitionEnterTimeout', 'transitionLeaveTimeout', 'renderNode', 'lastChild']);
